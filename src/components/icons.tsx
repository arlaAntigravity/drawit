...
export const AlignRightIcon = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
    <line x1="3" y1="4" x2="3" y2="20" />
    <rect x="9" y="7" width="12" height="4" rx="1" />
    <rect x="14" y="13" width="7" height="4" rx="1" />
  </svg>
);

export const AlignCenterHorizontalIcon = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
...
export const AlignTopIcon = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
...
export const AlignBottomIcon = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
    <line x1="4" y1="3" x2="20" y2="3" />
    <rect x="7" y="9" width="4" height="12" rx="1" />
    <rect x="13" y="14" width="4" height="7" rx="1" />
  </svg>
);

export const AlignCenterVerticalIcon = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
